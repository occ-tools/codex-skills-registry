const RULES = [
    ...
    },
    {
        ...
        description: "bearer_token_env_var should name an environment variable, not use shell-specific or literal value syntax.",
    ...
    },
    {
        ...
        description: "env_http_headers values should be environment variable names that resolve at runtime.",
    ...
    },
    {
        ...
        description: "pull_request_target runs with elevated repository context and can expose write tokens to unsafe logic.",
        remediation: "Prefer pull_request or isolate untrusted checkout, input interpolation, and write operations.",
    },
    {
        code: "WORKFLOW_UNPINNED_ACTION",
        title: "Unpinned workflow action",
        description: "A workflow action reference uses a mutable tag or branch instead of a full commit SHA.",
    ...
    },
    {
        ...
        remediation: "Pass PR values through environment variables and quote shell references carefully.",
    },
    {
