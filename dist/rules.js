const RULES = [
    ...
    },
    {
        ...
        description: "The project policy allows only specific skills and this skill is outside that list.",
    ...
    },
    {
        ...
        description: "The project policy allows only specific MCP servers and this server is outside that list.",
    ...
    },
    {
        ...
        description: "The project policy allows only specific plugins and this plugin is outside that list.",
